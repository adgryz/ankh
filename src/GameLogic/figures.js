...
const getInitialState = () => {
    return {
        gods: {
            g1: { id: 'g1', playerId: 'p1', x: 2, y: 7 },
            g2: { id: 'g2', playerId: 'p2', x: 3, y: 7 },
        },
        warriors: {
            w11: { id: 'w11', playerId: 'p1', x: 4, y: 5 },
            w12: { id: 'w12', playerId: 'p1', x: 4, y: 7 },
            w21: { id: 'w21', playerId: 'p2', x: 1, y: 6 },
            w22: { id: 'w22', playerId: 'p2', x: 5, y: 5 },
        },
        sentinels: {
    ...
    reducers: {
        addFigure: (state, { payload }) => {
            ...
            if (figureId.startsWith('g')) {
                state.gods[figureId] = { id: figureId, playerId, x, y };;
            }
            if (figureId.startsWith('w')) {
                state.warriors[figureId] = { id: figureId, playerId, x, y };;
            }
            if (figureId.startsWith('s')) {
                state.sentinels[figureId] = { id: figureId, playerId, x, y };;
            }
        },
